...
class TypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type_name' => ['type' => 'string', 'length' => 256, 'null' => false, 'default' => null, 'collate' => 'utf8_unicode_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['type_id'], 'length' => []],
            'type_id' => ['type' => 'unique', 'columns' => ['type_id'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'MyISAM',
